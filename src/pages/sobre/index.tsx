import StylesSobre from './Sobre.module.scss';
...
export default function Sobre() {
	...
	return (
		<section>
			...
			<div className={StyleTema.sobreNos}>
				<img src={casa} alt="Casa Aluroni" />
				<div className={StylesSobre.sobreNos__texto}>
					<p>
			...
			<div className={StylesSobre.imagens}>
				{imagens.map((imagem, index) => (
					<div key={index}>
						<img src={imagem} alt="Casa Aluroni" className={StylesSobre.imagens__imagem} />
					</div>
				))}
			</div>
		</section>
